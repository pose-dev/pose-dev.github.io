function toMenuItem(e) {
    var t = getMenuCenter(e);
    $(".js-mline").stop().animate({
        left: t
    }, 200)
}

function getMenuCenter(e) {
    if (!e.position()) return 17.5;
    var t = 50,
        n = e.position().left + (e.width() - t) / 2;
    return n > 0 ? n : 0
}
...
function fallback(e) {
    ...
    function p(e, t, n, r, i) {
        for (var o, s, a, u, l, p, d = t.createDocumentFragment(), h = [], v = 0, g = e.length; g > v; v++)
            if (o = e[v], o || 0 === o)
                if ("object" === oe.type(o)) oe.merge(h, o.nodeType ? [o] : o);
                else if (Fe.test(o)) {
            for (s = s || d.appendChild(t.createElement("div")), a = (Oe.exec(o) || ["", ""])[1].toLowerCase(), u = Me[a] || Me._default, s.innerHTML = u[1] + oe.htmlPrefilter(o) + u[2], p = u[0]; p--;) s = s.lastChild;
            oe.merge(h, s.childNodes), s = d.firstChild, s.textContent = ""
        } else h.push(t.createTextNode(o));
        for (d.textContent = "", v = 0; o = h[v++];)
    ...
    function C(e, t, n, r) {
        ...
        var i, o, s, a, u, l, f = 0,
            ...
            v = t[0],
            g = oe.isFunction(v);
        if (g || d > 1 && "string" == typeof v && !re.checkClone && Be.test(v)) return e.each(function (i) {
            var o = e.eq(i);
            g && (t[0] = v.call(this, i, o.html())), C(o, t, n, r)
        });
        if (d && (i = p(t, e[0].ownerDocument, !1, e, r), o = i.firstChild, 1 === i.childNodes.length && (i = o), o || r)) {
            ...
            if (a)
                for (l = s[s.length - 1].ownerDocument, oe.map(s, x), f = 0; a > f; f++) u = s[f], $e.test(u.type || "") && !Se.access(u, "globalEval") && oe.contains(l, u) && (u.src ? oe._evalUrl && oe._evalUrl(u.src) : oe.globalEval(u.textContent.replace(Xe, "")))
        }
        return e
    }
    ...
    function S(e) {
        var t = G,
            n = Ve[e];
        return n || (n = E(e, t), "none" !== n && n || (Ue = (Ue || oe("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement), t = Ue[0].contentDocument, t.write(), t.close(), n = E(e, t), Ue.detach()), Ve[e] = n), n
    }
    ...
    function L(e, t, n) {
        ...
        if (0 >= i || null == i) {
            if (i = k(e, t, o), (0 > i || null == i) && (i = e.style[t]), Ge.test(i)) return i;
    ...
    function q(e, t) {
        for (var n, r, i, o = [], s = 0, a = e.length; a > s; s++) r = e[s], r.style && (o[s] = Se.get(r, "olddisplay"), n = r.style.display, t ? (o[s] || "none" !== n || (r.style.display = ""), "" === r.style.display && qe(r) && (o[s] = Se.access(r, "olddisplay", S(r.nodeName)))) : (i = qe(r), "none" === n && i || Se.set(r, "olddisplay", i ? n : oe.css(r, "display"))));
    ...
    function F(e, t, n) {
        ...
        })), 1 === e.nodeType && ("height" in t || "width" in t) && (n.overflow = [d.overflow, d.overflowX, d.overflowY], l = oe.css(e, "display"), c = "none" === l ? Se.get(e, "olddisplay") || S(e.nodeName) : l, "inline" === c && "none" === oe.css(e, "float") && (d.display = "inline-block")), n.overflow && (d.overflow = "hidden", f.always(function () {
        ...
        for (r in t)
            if (i = t[r], st.exec(i)) {
                ...
                p[r] = v && v[r] || oe.style(e, r)
            } else l = void 0;
        if (oe.isEmptyObject(p)) "inline" === ("none" === l ? S(e.nodeName) : l) && (d.display = l);
        else {
            v ? "hidden" in v && (h = v.hidden) : v = Se.access(e, "fxshow", {}), o && (v.hidden = !h), h ? oe(e).show() : f.done(function () {
                oe(e).hide()
            }), f.done(function () {
                var t;
                Se.remove(e, "fxshow");
            ...
            for (r in p) s = M(h ? v[r] : 0, r, f), r in v || (v[r] = s.start, h && (s.end = s.start, s.start = "width" === r || "height" === r ? 1 : 0))
        }
    }
    ...
    function R(e, t, n) {
        ...
        return oe.map(c, M, l), oe.isFunction(l.opts.start) && l.opts.start.call(e, l), oe.fx.timer(oe.extend(u, {
            elem: e,
            anim: l,
            queue: l.opts.queue
    ...
    var ce = function (e) {
            ...
            if (!r && ((t ? t.ownerDocument || t : I) !== q && L(t), t = t || q, O)) {
                ...
                if (w.qsa && !X[e + " "] && (!$ || !$.test(e))) {
                    if (1 !== v) h = t, d = e;
                        ...
                        for ((a = t.getAttribute("id")) ? a = a.replace(xe, "\\$&") : t.setAttribute("id", a = R), f = S(e), o = f.length, u = pe.test(a) ? "#" + a : "[id='" + a + "']"; o--;) f[o] = u + " " + p(f[o]);
        ...
        var b, w, C, T, E, S, k, N, A, j, D, L, q, H, O, $, M, F, P, R = "sizzle" + 1 * new Date,
            I = e.document,
            W = 0,
            _ = 0,
            B = n(),
        ...
        w = t.support = {}, E = t.isXML = function (e) {
            ...
            return r !== q && 9 === r.nodeType && r.documentElement ? (q = r, H = q.documentElement, O = !E(q), (n = q.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", Ce, !1) : n.attachEvent && n.attachEvent("onunload", Ce)), w.attributes = i(function (e) {
            ...
            }, M = [], $ = [], (w.qsa = ge.test(q.querySelectorAll)) && (i(function (e) {
            ...
            })), (w.matchesSelector = ge.test(F = H.matches || H.webkitMatchesSelector || H.mozMatchesSelector || H.oMatchesSelector || H.msMatchesSelector)) && i(function (e) {
                w.disconnectedMatch = F.call(e, "div"), F.call(e, "[s!='']:x"), M.push("!=", oe)
            }), $ = $.length && new RegExp($.join("|")), M = M.length && new RegExp(M.join("|")), t = ge.test(H.compareDocumentPosition), P = t || ge.test(H.contains) ? function (e, t) {
            ...
            if ((e.ownerDocument || e) !== q && L(e), n = n.replace(ce, "='$1']"), w.matchesSelector && O && !X[n + " "] && (!M || !M.test(n)) && (!$ || !$.test(n))) try {
                var r = F.call(e, n);
                    ...
                    return 1 === r && 0 === i ? function (e) {
                        ...
                        if (g) {
                            ...
                            if (h = [s ? g.firstChild : g.lastChild], s && y) {
                                for (p = g, f = p[R] || (p[R] = {}), c = f[p.uniqueID] || (f[p.uniqueID] = {}), l = c[e] || [], d = l[0] === W && l[1], x = d && l[2], p = d && g.childNodes[d]; p = ++d && p && p[v] || (x = d = 0) || h.pop();)
                                    if (1 === p.nodeType && ++x && p === t) {
                                        c[e] = [W, d, x];
                                        break
                                    }
                            } else if (y && (p = t, f = p[R] || (p[R] = {}), c = f[p.uniqueID] || (f[p.uniqueID] = {}), l = c[e] || [], d = l[0] === W && l[1], x = d), x === !1)
                                for (;
                                    (p = ++d && p && p[v] || (x = d = 0) || h.pop()) && ((a ? p.nodeName.toLowerCase() !== m : 1 !== p.nodeType) || !++x || (y && (f = p[R] || (p[R] = {}), c = f[p.uniqueID] || (f[p.uniqueID] = {}), c[e] = [W, x]), p !== t)););
        ...
        return f.prototype = C.filters = C.pseudos, C.setFilters = new f, S = t.tokenize = function (e, n) {
            ...
            return (l || k(e, f))(r, t, !O, n, !t || ye.test(e) && c(t.parentNode) || t), n
    ...
    oe.event = {
        ...
        add: function (e, t, n, r, i) {
            var o, s, a, u, l, c, f, p, d, h, v, g = Se.get(e);
            if (g)
                for (n.handler && (o = n, n = o.handler, i = o.selector), n.guid || (n.guid = oe.guid++), (u = g.events) || (u = g.events = {}), (s = g.handle) || (s = g.handle = function (t) {
                    ...
                    }), t = (t || "").match(we) || [""], l = t.length; l--;) a = Ie.exec(t[l]) || [], d = v = a[1], h = (a[2] || "").split(".").sort(), d && (f = oe.event.special[d] || {}, d = (i ? f.delegateType : f.bindType) || d, f = oe.event.special[d] || {}, c = oe.extend({
                    type: d,
                    origType: v,
                    data: r,
                    handler: n,
        ...
        remove: function (e, t, n, r, i) {
            var o, s, a, u, l, c, f, p, d, h, v, g = Se.hasData(e) && Se.get(e);
            if (g && (u = g.events)) {
                for (t = (t || "").match(we) || [""], l = t.length; l--;)
                    if (a = Ie.exec(t[l]) || [], d = v = a[1], h = (a[2] || "").split(".").sort(), d) {
                        for (f = oe.event.special[d] || {}, d = (r ? f.delegateType : f.bindType) || d, p = u[d] || [], a = a[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = o = p.length; o--;) c = p[o], !i && v !== c.origType || n && n.guid !== c.guid || a && !a.test(c.namespace) || r && r !== c.selector && ("**" !== r || !c.selector) || (p.splice(o, 1), c.selector && p.delegateCount--, f.remove && f.remove.call(e, c));
                        s && !p.length && (f.teardown && f.teardown.call(e, h, g.handle) !== !1 || oe.removeEvent(e, d, g.handle), delete u[d])
                    } else
        ...
        fix: function (e) {
            ...
            var t, n, r, i = e.type,
                o = e,
                s = this.fixHooks[i];
            for (s || (this.fixHooks[i] = s = Re.test(i) ? this.mouseHooks : Pe.test(i) ? this.keyHooks : {}), r = s.props ? this.props.concat(s.props) : this.props, e = new oe.Event(o), t = r.length; t--;) n = r[t], e[n] = o[n];
    ...
    oe.extend({
        ...
        html: function (e) {
            return Te(this, function (e) {
                ...
                if ("string" == typeof e && !_e.test(e) && !Me[(Oe.exec(e) || ["", ""])[1].toLowerCase()]) {
    ...
    oe.extend({
        ...
        css: function (e, t, n, r) {
            var i, o, s, a = oe.camelCase(t);
            return t = oe.cssProps[a] || (oe.cssProps[a] = A(a) || a), s = oe.cssHooks[t] || oe.cssHooks[a], s && "get" in s && (i = s.get(e, !0, n)), void 0 === i && (i = k(e, t, r)), "normal" === i && t in tt && (i = tt[t]), "" === n || n ? (o = parseFloat(i), n === !0 || isFinite(o) ? o || 0 : i) : i
        }
        ...
        oe.cssHooks[t] = {
            ...
            set: function (e, n, r) {
                ...
                return s && (i = De.exec(n)) && "px" !== (i[3] || "px") && (e.style[t] = n, n = oe.css(e, t)), j(e, n, s)
            }
        }
    ...
    oe.fn.extend({
        ...
        toggleClass: function (e, t) {
            ...
            return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : oe.isFunction(e) ? this.each(function (n) {
                ...
                else void 0 !== e && "boolean" !== n || (t = I(this), t && Se.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || e === !1 ? "" : Se.get(this, "__className__") || ""))
            })
        },
        hasClass: function (e) {
            var t, n, r = 0;
    ...
    oe.extend(oe.event, {
        trigger: function (t, n, r, i) {
            ...
            if (s = a = r = r || G, 3 !== r.nodeType && 8 !== r.nodeType && !vt.test(d + oe.event.triggered) && (d.indexOf(".") > -1 && (h = d.split("."), d = h.shift(), h.sort()), l = d.indexOf(":") < 0 && "on" + d, t = t[oe.expando] ? t : new oe.Event(d, "object" == typeof t && t), t.isTrigger = i ? 2 : 3, t.namespace = h.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = r), n = null == n ? [t] : oe.makeArray(n, [t]), f = oe.event.special[d] || {}, i || !f.trigger || f.trigger.apply(r, n) !== !1)) {
                if (!i && !f.noBubble && !oe.isWindow(r)) {
                    for (u = f.delegateType || d, vt.test(u + d) || (s = s.parentNode); s; s = s.parentNode) p.push(s), a = s;
                    a === (r.ownerDocument || G) && p.push(a.defaultView || a.parentWindow || e)
                }
                for (o = 0;
                    (s = p[o++]) && !t.isPropagationStopped();) t.type = o > 1 ? u : f.bindType || d, c = (Se.get(s, "events") || {})[t.type] && Se.get(s, "handle"), c && c.apply(s, n), c = l && s[l], c && c.apply && Ee(s) && (t.result = c.apply(s, n), t.result === !1 && t.preventDefault());
                return t.type = d, i || t.isDefaultPrevented() || f._default && f._default.apply(p.pop(), n) !== !1 || !Ee(r) || l && oe.isFunction(r[d]) && !oe.isWindow(r) && (a = r[l], a && (r[l] = null), oe.event.triggered = d, r[d](), oe.event.triggered = void 0, a && (r[l] = a)), t.result
            }
        },
    ...
    At.href = gt.href, oe.extend({
        ...
        ajax: function (t, n) {
            function r(t, n, r, a) {
                var l, f, y, x, w, T = n;
                2 !== b && (b = 2, u && e.clearTimeout(u), i = void 0, s = a || "", C.readyState = t > 0 ? 4 : 0, l = t >= 200 && 300 > t || 304 === t, r && (x = z(p, C, r)), x = X(p, x, C, l), l ? (p.ifModified && (w = C.getResponseHeader("Last-Modified"), w && (oe.lastModified[o] = w), w = C.getResponseHeader("etag"), w && (oe.etag[o] = w)), 204 === t || "HEAD" === p.type ? T = "nocontent" : 304 === t ? T = "notmodified" : (T = x.state, f = x.data, y = x.error, l = !y)) : (y = T, !t && T || (T = "error", 0 > t && (t = 0))), C.status = t, C.statusText = (n || T) + "", l ? v.resolveWith(d, [f, T, C]) : v.rejectWith(d, [C, T, y]), C.statusCode(m), m = void 0, c && h.trigger(l ? "ajaxSuccess" : "ajaxError", [C, p, l ? f : y]), g.fireWith(d, [C, T]), c && (h.trigger("ajaxComplete", [C, p]), --oe.active || oe.event.trigger("ajaxStop")))
            }
            ...
            if (v.promise(C).complete = g.add, C.success = C.done, C.error = C.fail, p.url = ((t || p.url || gt.href) + "").replace(xt, "").replace(Et, gt.protocol + "//"), p.type = n.method || n.type || p.method || p.type, p.dataTypes = oe.trim(p.dataType || "*").toLowerCase().match(we) || [""], null == p.crossDomain) {
                l = G.createElement("a");
                try {
            ...
            if (p.data && p.processData && "string" != typeof p.data && (p.data = oe.param(p.data, p.traditional)), _(St, p, n, C), 2 === b) return C;
    ...
    oe.fn.load = function (e, t, n) {
        ...
        oe.cssHooks[t] = N(re.pixelPosition, function (e, n) {
            return n ? (n = k(e, t), Ge.test(n) ? oe(e).position()[t] + "px" : n) : void 0
        })
    }), oe.each({
        Height: "height",
        Width: "width"
...
function () {
    ...
    t = function () {
        ...
        return i.prototype.defaults = {
            ...
            var t, n, r, i, o;
            return n = e.getAttribute("data-wow-offset") || this.config.offset, o = this.config.scrollContainer && this.config.scrollContainer.scrollTop || window.pageYOffset, i = o + Math.min(this.element.clientHeight, this.util().innerHeight()) - n, r = this.offsetTop(e), t = r + e.clientHeight, i >= r && t >= o
    ...
    function e() {
        ...
        $active = r.filter('[href="#' + o + '"]').parent(), r.parent().removeClass("active"), $active.addClass("active"), toMenuItem($active)
    }
    $(".header__menu > li").hover(function () {
        toMenuItem($(this))
    }), $(".header__menu").hover(function () {}, function () {
        toMenuItem($(".header__menu > li.active"))
    });
    var t = $(".header__menu"),
        n = t.outerHeight() + 400,
        r = t.find('a[href*="#"]'),
    ...
    $(document).on("scroll", e), $page = $("html, body"), $('a[href*="#"]').click(function () {
            var e = jQuery(this).attr("href");
            if ("#" !== e) return $(".header__nav").removeClass("active"), $(".hamburger").removeClass("active"), $page.animate({
                scrollTop: $($.attr(this, "href")).offset().top - 90
            }, 500), !1
        }), $(".js-popup").on("click", function () {
            if (!$(this).attr('disabled')) {
                $(".header__nav").removeClass("active"), $(".hamburger").removeClass("active"), $(".modal").fadeOut(500);
                var e = $(this).attr("data-id");
                return $("#js-popup_" + e).fadeIn(500), $("body").addClass("modal-active"), !1
            }
            return !1
        }), $(".js-team_readmore").on("click", function () {
            var e = $(this).attr("data-id");
            return $("#js-modal_" + e).fadeIn(500), $("body").addClass("modal-active"), !1
        }), $(".js-modal_close").on("click", function () {
            return $(this).parents(".modal").fadeOut(500), $("body").removeClass("modal-active"), !1
        }), $(".checkbox-input").on("click", function () {
            $(this).is(":checked") ? $(".js-btn_register").removeAttr("disabled") : $(".js-btn_register").attr("disabled", "")
        }),
        function () {
            "use strict";
            ...
            function e(e) {
                e.addEventListener("click", function (e) {
                    e.preventDefault();
                    var t = $(".header__nav");
                    return !t.is(":animated") && (this.classList.contains("active") === !0 ? this.classList.remove("active") : this.classList.add("active"), void(this.classList.contains("active") === !0 ? t.addClass("active") : t.removeClass("active")))
                })
            }
            for (var t = document.querySelectorAll(".hamburger"), n = t.length - 1; n >= 0; n--) {
                var r = t[n];
                e(r)
            }
        }(), (new WOW).init(), $("body").bind("touchstart", function () {})
});
$(document).ready(function () {
    ...
    var timeLeft = new Date("Feb 28 2018 00:00:00") - Date.now();
    timeLeft = (timeLeft / 1000 / 60 / 60 / 24).toFixed(0);
    if (timeLeft > 0) {
        $('#js-preico').text(timeLeft)
    }
    $('.yt-video_close').on('click', function () {
        $('.js-yt_video').attr('src', function (i, val) {
            return val
        })
    });
    $('.checkbox').on('click', function () {
        if ($("#tmp1:checked,#tmp2:checked").length == 2) {
            $('.js-btn_verify').removeAttr('disabled')
        } else {
            $('.js-btn_verify').attr('disabled', '')
        }
    })
